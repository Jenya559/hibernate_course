...
//
//        System.out.println("afterGetStudentsLoggingAdvice: логгируем получение списка студентов после метода getStudents");
//    }
...
@After("execution(* getStudents())")
    ...
    System.out.println("afterGetStudentsLoggingAdvice: логируем нормальное окончание работы метода/выброс исключения");
}
}
